...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 200.26
  #define DEFAULT_bedKi  39.11
  #define DEFAULT_bedKd 683.56
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, 3, -4.23 }  // MRiscoC BLTouch offset for support: https://www.thingiverse.com/thing:4605354 (z-offset = -1.80 mm)
...
#define X_BED_SIZE X_MAX_POS  // MRiscoC Max usable bed size
#define Y_BED_SIZE Y_MAX_POS  // MRiscoC Max usable bed size
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 7  // MRiscoC Customizable by menu
